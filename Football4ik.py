...
GRAVITY_CHANGE_INTERVAL = 5000  # интервал в миллисекундах для смены гравитационной точки
...
player2_score = 0
running_game = False
music_playing = True  # Переменная для отслеживания состояния музыки
...
def gravity_pong():
    ...
    # Локальные переменные для гравитационного режима
    player1_pos = [10, HEIGHT // 2 - PLAYER_HEIGHT // 2]
    player2_pos = [WIDTH - 10 - PLAYER_WIDTH, HEIGHT // 2 - PLAYER_HEIGHT // 2]
    player1_speed = 0
    player2_speed = 0
    ...
    while running_game:
        ...
        # Обновление гравитационной точки
...
if __name__ == '__main__':
    while True:
        ...
        if main_menu.is_enabled():
            ...
            pygame.mixer.music.unpause()  # Возобновление музыки при открытом главном меню
